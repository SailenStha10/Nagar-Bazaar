...
// Mirrors SellerTopBar.jsx exactly (same fixed full-width bar, same sizing)
// so the admin area's top bar matches the seller dashboard's instead of
// falling back to the site's floating pill navbar.
export default function AdminTopBar() {
  ...
  // The admin login screen (bare route, no sidebar) shouldn't get this bar.
    ...
    <div className="fixed inset-x-0 top-0 z-50 border-b border-border bg-surface-raised px-4 py-3 shadow-sm lg:pl-83">
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder="Search users, sellers, complaints..."

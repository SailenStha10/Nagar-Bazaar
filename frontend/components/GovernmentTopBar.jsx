...
// Mirrors SellerTopBar.jsx / AdminTopBar.jsx exactly (same fixed full-width
// bar, same sizing) so the officer dashboard's top bar matches the other
// dashboards instead of falling back to the site's floating pill navbar.
    ...
    <div className="fixed inset-x-0 top-0 z-50 border-b border-border bg-surface-raised px-4 py-3 shadow-sm lg:pl-83">
      <div className="flex items-center gap-3">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            type="text"
            placeholder="Search sellers, complaints, prices..."
        ...
        <div className="ml-auto flex shrink-0 items-center gap-2">
          ...
          <div ref={menuRef} className="relative">
            ...
            >
              ...
              <span className="hidden sm:inline">{user?.name?.split(' ')[0] || 'Officer'}</span>
            </button>
